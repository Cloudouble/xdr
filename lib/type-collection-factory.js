function typeCollectionFactory(BaseClass, parametersCollection) {
    const { defaultParameters, parameters, unsignedParameters, optionalParameters } = parametersCollection
    return class TypeCollection extends BaseClass {
