const rx = {
    ...
    const $this = this, parseX = (xCode, entry, name) => {
        ...
        const entryIsMemberOf = addUsedMembers(entry), usedManifest = { ...this.types._base.BaseClass.manifest, entry, name, namespace, ...used }
        ...
        const typeClass = entryIsMemberOf === 'enums'
            ...
            : class extends this.types._base.BaseClass {
                static entry = entry
                static name = name
